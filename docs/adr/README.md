...
| [ADR-0037](ADR-0037-feature-generic-entity-class.md)                 | Generic principal de Feature — `Feature<TEntityClass, TChannel>` (amende D17)                                                       | 🟢 Accepted   | 2026-04-21                      | feature.md, entity.md, conventions-typage.md, ADR-0001, ADR-0024                                                                        |
