# Guide de Style de Code — Pipeline de Build

> **Conventions de codage pour le système de build et les outils internes du framework Bonsai**
...
>
> Pour les conventions applicatives du framework (Views, Features, Entities, Channels,
> DOM, API TypeScript publique), voir le [Framework Style Guide](FRAMEWORK-STYLE-GUIDE.md).
...
- Utiliser `vi.fn()` / `vi.spyOn()` pour les mocks (API Vitest, pas Jest)
